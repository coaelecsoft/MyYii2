...
<main>
    ...
    foreach ($others as $slave) {
        if ($slave->page_option != '3') {
            ...
            <!-- Section of post on home page -->        
            <section  id="<?= $slave->$link_name ?>" class="my-container">
                <header class="<?= 'text-image-' . $slave->page_option ?>">
                    <div class="text-panel">
                        ...
                        <?php if ($slave->subarticle == '0' and $slave->slaves) {///If not be activated showing subarticles panel and if have recorde in $slave->slaves, show button with link to main page of subarticles ?>
                            <nav> 
                                <?=
                    ...
                    <?php
                            if ($slave->subarticle == '0' and $slave->image1) {
                                ?>
                                <figure class="image-panel">
                ...
                <?php
                if ($slave->slaves and $slave->subarticle == '1') {
                    ?>
